...
function field_bool(pojo, fd, fk, root, ffid) {
    ...
    var el = (_a = ["\n<div class=", ">\n  <label class=\"form-switch\">\n    <input type=\"checkbox\" checked=", " onchange=", " />\n    <i class=\"form-icon\"></i>", "\n  </label>\n</div>\n"], _a.raw = [/**/ "\n<div class=", ">\n  <label class=\"form-switch\">\n    <input type=\"checkbox\" checked=", " onchange=", " />\n    <i class=\"form-icon\"></i>", "\n  </label>\n</div>\n"], html /**/(_a, cls, function () { return !!pojo[fk]; }, function (e) { return $change(e, fk, pojo, root.update, root.pojo); }, fd.$n)); /**/
...
function field_enum(pojo, fd, fk, root, ffid, label) {
    var cls = fd.m === 2 ? 'form-group required' : 'form-group';
    var el = (_a = ["\n<div class=", ">\n  ", "\n  <select class=", " value=", " onchange=", "></select>\n</div>\n"], _a.raw = [/**/ "\n<div class=", ">\n  ", "\n  <select class=", " value=", " onchange=", "></select>\n</div>\n"], html /**/(_a, cls, label, function () { return !root.update && !pojo[fk] ? 'empty' : ''; }, select_val(pojo[fk]), function (e) { return $change(e, fk, pojo, root.update, root.pojo); })); /**/
