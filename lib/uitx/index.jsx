...
export function dropdown_msg(hs, mask) {
    return (<div class={('dropdown' + (hs.msg && ' active' || ''))}>
...
export function pager_controls(pager) {
  ...
  <button class="btn btn-link btn-sm" onClick={sort} disabled={(0 !== (8 /* LOADING */ & pager.state) || 2 > pager.size)}>
    <i class={((16 /* DESC */ & pager.state) ? 'icon desc-yes' : 'icon desc-no')}></i>
  </button>
  <button class="btn btn-link btn-sm" onClick={reload} disabled={(0 !== (264 /* MASK_RPC_DISABLE */ & pager.state) || 0 === pager.size)}>
    <i class="icon cw"></i>
  </button>
  <button class="btn btn-link btn-sm" onClick={gotoFirst} disabled={(0 !== (8 /* LOADING */ & pager.state) || 0 === pager.page)}>
    <i class="icon angle-double-left"></i>
  </button>
  <button class="btn btn-link btn-sm" onClick={prevOrLoad} disabled={(0 !== (264 /* MASK_RPC_DISABLE */ & pager.state))}>
    <i class="icon angle-left"></i>
  </button>
  <button class="btn btn-link btn-sm" onClick={nextOrLoad} disabled={(0 !== (264 /* MASK_RPC_DISABLE */ & pager.state) || 0 === pager.size)}>
    <i class="icon angle-right"></i>
  </button>
  <button class="btn btn-link btn-sm" onClick={gotoLast} disabled={(0 !== (8 /* LOADING */ & pager.state) || 0 === pager.size || pager.page_count === pager.page)}>
