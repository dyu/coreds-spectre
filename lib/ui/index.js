...
export function icon_remove(bit, icon_class, name, wrapper_class) {
    if (bit < 32)
        throw 'Invalid bit: ' + bit;
    var attrs = !wrapper_class ? '' : " class=\"" + wrapper_class + "\"";
...
export var icon_remove_bit32 = icon_remove(32, 'trash empty');
// ================================================== 
// item
...
export function item_remove(bit, icon_class, name) {
