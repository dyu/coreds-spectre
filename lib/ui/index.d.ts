...
export declare function icon_remove(bit: number, icon_class: string, name?: string, wrapper_class?: string): string;
...
export declare function item_remove(bit: number, icon_class: string, name?: string): string;
